...
import { TransferCourseReportComponent } from './transfer-course-report/transfer-course-report.component';
import { SkillMappingReportComponent } from './skill-mapping-report/skill-mapping-report.component';
import { DetailDepartmentIncomeReportComponent } from './department-income-report/detail-department-income-report/detail-department-income-report.component';
...
@NgModule({
    ...
    TransferCourseReportComponent,
    SkillMappingReportComponent,
    DetailDepartmentIncomeReportComponent
  ],
    imports: [
        CommonModule,
        ReportRoutingModule,
