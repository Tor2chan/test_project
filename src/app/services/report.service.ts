...
import { CourseMainData, CoursepublicMainData } from '../models/course-management';
...
import { MasGeneralSkillData, MasOccupationData } from '../models/master';
import { ReportDepartmentIncomeDetailData } from '../models/report/reportDepartmentIncomeDetailData';
...
export class ReportService {
    ...
    findTransferCourseData(swuCurriculumData: SwuCurriculumData): Observable<ResponseListIf<SwuCurriculumData>> {
        return this.http.post<ResponseListIf<SwuCurriculumData>>(`${environment.apiUrl}/report/find-transfer-course-data`, swuCurriculumData);
    }

    findOccupationData(criteria): Observable<ResponseListIf<MasOccupationData>> {
        return this.http.post<ResponseListIf<MasOccupationData>>(`${environment.apiUrl}/report/find-occupation-data`, criteria);
    }

    findSkillData(criteria): Observable<ResponseListIf<MasGeneralSkillData>> {
        return this.http.post<ResponseListIf<MasGeneralSkillData>>(`${environment.apiUrl}/report/find-skill-data`, criteria);
    }

    findCourseData(criteria): Observable<ResponseListIf<CourseMainData>>{
        return this.http.post<ResponseListIf<CourseMainData>>(`${environment.apiUrl}/report/find-course-data`, criteria);
    }

    getDetailDepartmentIncome(depId: number): Observable<ResponseOneIf<CoursepublicMainData>> {
        return this.http.get<ResponseOneIf<CoursepublicMainData>>(
            `${environment.apiUrl}/report/detail-department-income/${depId}`
        );
    }
    findDetailDepartmentIncome(
        reportDepartmentIncomeDetailData: ReportDepartmentIncomeDetailData
    ): Observable<ResponseListIf<ReportDepartmentIncomeDetailData>> {
        return this.http.post<ResponseListIf<ReportDepartmentIncomeDetailData>>(
            `${environment.apiUrl}/report/find-detail-department-income`,
            reportDepartmentIncomeDetailData
        );
    }
