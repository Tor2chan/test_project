...
export class DropdownService {
    ...
    getOccupationCustomLanguageDropdown(dropdownCriteriaData: DropdownCriteriaData): Observable<ResponseListIf<DropdownData>> {
        return this.http.post<ResponseListIf<DropdownData>>(
            `${environment.apiUrl}/dropdown/occupation-custom-language`,
            dropdownCriteriaData
        );
    }
    ...
    getGeneralSkillCustomLanguageDropdown(dropdownCriteriaData: DropdownCriteriaData): Observable<ResponseListIf<DropdownData>> {
        return this.http.post<ResponseListIf<DropdownData>>(
            `${environment.apiUrl}/dropdown/general-skill-custom-language`,
            dropdownCriteriaData
        );
    }
    ...
    getFiscalYearDropdown(dropdownCriteriaData: DropdownCriteriaData): Observable<ResponseListIf<DropdownData>> {
        return this.http.post<ResponseListIf<DropdownData>>(
            `${environment.apiUrl}/dropdown/fiscal-year`,
            dropdownCriteriaData
        );
    }
}
