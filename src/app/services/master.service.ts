...
import type {
    ...
    MasBankChargeData,
    MasBankData,
    MasConsentDiscloseData,
    MasCourseTypeData,
    MasDepartmentData,
    MasExternalPersonalData,
    MasGeneralSkillData,
    MasOccupationData,
...
import { AutUserData, MemberCourseData } from '../models/user-management';
import { MasWebsiteBannerData } from '../models/master/masWebsiteBannerData';
import { MasConsentManageData } from './../models/master/masConsentManageData';
...
export class MasterService {
    ...
    getDepartmentType(depType: number): Observable<ResponseListIf<MasDepartmentData>> {
        return this.http.get<ResponseListIf<MasDepartmentData>>(`${environment.apiUrl}/master/department-type/${depType}`);
    }
    ...
    findExternalPersonal(
        masExternalPersonalData: MasExternalPersonalData
    ): Observable<ResponseListIf<MasExternalPersonalData>> {
        return this.http.post<ResponseListIf<MasExternalPersonalData>>(
            `${environment.apiUrl}/master/find-external-personal`,
            masExternalPersonalData
        );
    }
    ...
    deleteWebsiteBanner(bannerId: number): Observable<ResponseOneIf<null>> {
        return this.http.delete<ResponseOneIf<null>>(`${environment.apiUrl}/master/website-banner/delete/${bannerId}`);
    }

    findConsentManagement(
        masConsentManageData: MasConsentManageData
    ): Observable<ResponseListIf<MasConsentManageData>> {
        return this.http.post<ResponseListIf<MasConsentManageData>>(
            `${environment.apiUrl}/master/find-consent-manage`,
            masConsentManageData
        );
    }

    findConsentDisclose(
        masConsentDiscloseData: MasConsentDiscloseData
    ): Observable<ResponseListIf<MasConsentDiscloseData>> {
        return this.http.post<ResponseListIf<MasConsentDiscloseData>>(
            `${environment.apiUrl}/master/find-consent-disclose`,
            masConsentDiscloseData
        );
    }

    findMemberConsent(memberConsentData: MemberConsentData): Observable<ResponseListIf<MemberConsentData>> {
        return this.http.post<ResponseListIf<MemberConsentData>>(
            `${environment.apiUrl}/master/find-member-consent`,
            memberConsentData
        );
    }

    postConsentManagement(masConsentManageData: MasConsentManageData): Observable<ResponseOneIf<MasConsentManageData>> {
        return this.http.post<ResponseOneIf<MasConsentManageData>>(
            `${environment.apiUrl}/master/consent-manage`,
            masConsentManageData
        );
    }
    postConsentDisclose(
        masConsentDiscloseData: MasConsentDiscloseData
    ): Observable<ResponseOneIf<MasConsentDiscloseData>> {
        return this.http.post<ResponseOneIf<MasConsentDiscloseData>>(
            `${environment.apiUrl}/master/consent-disclose`,
            masConsentDiscloseData
        );
    }
    putConsentManage(
        consentId: number,
        masConsentManageData: MasConsentManageData
    ): Observable<ResponseOneIf<MasConsentManageData>> {
        return this.http.put<ResponseOneIf<MasConsentManageData>>(
            `${environment.apiUrl}/master/consent-manage/${consentId}`,
            masConsentManageData
        );
    }
    putConsentDisclose(
        consentDiscloseId: number,
        masConsentDiscloseData: MasConsentDiscloseData
    ): Observable<ResponseOneIf<MasConsentDiscloseData>> {
        return this.http.put<ResponseOneIf<MasConsentDiscloseData>>(
            `${environment.apiUrl}/master/consent-disclose/${consentDiscloseId}`,
            masConsentDiscloseData
        );
    }
    getMasConsentManage(consentId: number): Observable<ResponseOneIf<MasConsentManageData>> {
        return this.http.get<ResponseOneIf<MasConsentManageData>>(
            `${environment.apiUrl}/master/consent-manage/${consentId}`
        );
    }
    getMasConsentDisclose(consentDiscloseId: number): Observable<ResponseOneIf<MasConsentDiscloseData>> {
        return this.http.get<ResponseOneIf<MasConsentDiscloseData>>(
            `${environment.apiUrl}/master/consent-disclose/${consentDiscloseId}`
        );
    }

    deleteConsentDisclose(criteria): Observable<ResponseListIf<MasConsentDiscloseData>> {
        return this.http.post<ResponseListIf<MasConsentDiscloseData>>(
            `${environment.apiUrl}/master/delete-consent-disclose`,
            criteria
        );
    }
    getHtmlFileBase64(notiId): Observable<ResponseListIf<NotiInfoData>> {
        return this.http.get<ResponseListIf<NotiInfoData>>(
            `${environment.apiUrl}/master/get-html-file-base64/${notiId}`
        );
    }
    findCurriculum(masCourseTypeData: SwuCerriculum): Observable<ResponseListIf<SwuCerriculum>> {
        return this.http.post<ResponseListIf<MasCourseTypeData>>(
            `${environment.apiUrl}/master/find-curriculum`,
            masCourseTypeData
        );
    }
    getCurriculumlPull(): Observable<ResponseOneIf<string>> {
        return this.http.get<ResponseOneIf<string>>(`${environment.apiUrl}/master/curriculum/pull`);
    }
    getCurriculumCheck(): Observable<ResponseOneIf<SysProgressData>> {
        return this.http.get<ResponseOneIf<SysProgressData>>(`${environment.apiUrl}/master/curriculum/check`);
    }
    findSubject(masCourseTypeData: SwuSubject): Observable<ResponseListIf<SwuCerriculum>> {
        return this.http.post<ResponseListIf<MasCourseTypeData>>(
            `${environment.apiUrl}/master/find-subject`,
            masCourseTypeData
        );
    }
    findCurriculumAll(masCourseTypeData: SwuCerriculum): Observable<ResponseListIf<SwuCerriculum>> {
        return this.http.post<ResponseListIf<MasCourseTypeData>>(
            `${environment.apiUrl}/master/find-curriculum-all`,
            masCourseTypeData
        );
    }
    getSubjectlPull(): Observable<ResponseOneIf<string>> {
        return this.http.get<ResponseOneIf<string>>(`${environment.apiUrl}/master/subject/pull`);
    }
    getSubjectCheck(): Observable<ResponseOneIf<SysProgressData>> {
        return this.http.get<ResponseOneIf<SysProgressData>>(`${environment.apiUrl}/master/subject/check`);
    }
}
