...
export class CourseManagementService {
    ...
    getCoursepublicMainCertificate(coursepublicId: number) {
        return this.http
            .get(`${environment.apiUrl}/course-management/coursepublic-main/certificate/${coursepublicId}`, {
                observe: 'response',
                responseType: 'blob'
            })
            .pipe(
    ...
    putCoursepublicMainMoreDetail(
        coursepublicId: number,
        coursepublicMainData: CoursepublicMainData
    ): Observable<ResponseOneIf<CoursepublicMainData>> {
        return this.http.put<ResponseOneIf<CoursepublicMainData>>(
            `${environment.apiUrl}/course-management/coursepublic-main/more-detail/${coursepublicId}`,
            coursepublicMainData
        );
    }
    putCoursepublicMainCertificate(
        coursepublicId: number,
        coursepublicMainData: CoursepublicMainData
    ): Observable<ResponseOneIf<CoursepublicMainData>> {
        return this.http.put<ResponseOneIf<CoursepublicMainData>>(
            `${environment.apiUrl}/course-management/coursepublic-main/certificate/${coursepublicId}`,
            coursepublicMainData
        );
    }
    ...
    findCoursepublicWorker(
        coursepublicWorkerData: CoursepublicWorkerData
    ): Observable<ResponseListIf<CoursepublicWorkerData>> {
        return this.http.post<ResponseListIf<CoursepublicWorkerData>>(
            `${environment.apiUrl}/course-management/find-coursepublic-worker`,
            coursepublicWorkerData
        );
    }
    ...
    postCoursepublicWorker(
        coursepublicWorkerData: CoursepublicWorkerData
    ): Observable<ResponseOneIf<CoursepublicWorkerData>> {
        return this.http.post<ResponseOneIf<CoursepublicWorkerData>>(
            `${environment.apiUrl}/course-management/coursepublic-worker`,
            coursepublicWorkerData
        );
    }
    ...
    postCoursepublicMainCopy(coursepublicMainData: CoursepublicMainData): Observable<ResponseOneIf<null>> {
        return this.http.post<ResponseOneIf<null>>(
            `${environment.apiUrl}/course-management/coursepublic-main/copy`,
            coursepublicMainData
        );
    }
    ...
    getCoursepublicWorker(coursepublicWorkerId: number): Observable<ResponseOneIf<CoursepublicWorkerData>> {
        return this.http.get<ResponseOneIf<CoursepublicWorkerData>>(
            `${environment.apiUrl}/course-management/coursepublic-worker/${coursepublicWorkerId}`
        );
    }
    putCoursepublicWorker(
        coursepublicWorkerId: number,
        coursepublicWorkerData: CoursepublicWorkerData
    ): Observable<ResponseOneIf<CoursepublicWorkerData>> {
        return this.http.put<ResponseOneIf<CoursepublicWorkerData>>(
            `${environment.apiUrl}/course-management/coursepublic-worker/${coursepublicWorkerId}`,
            coursepublicWorkerData
        );
    }
    deleteCoursepublicWorker(coursepublicWorkerId: number): Observable<ResponseOneIf<null>> {
        return this.http.delete<ResponseOneIf<null>>(
            `${environment.apiUrl}/course-management/coursepublic-worker/${coursepublicWorkerId}`
        );
    }
    ...
    getSharePercent(depId: number): Observable<ResponseOneIf<MasSharePercentData>> {
        return this.http.get<ResponseOneIf<MasSharePercentData>>(
            `${environment.apiUrl}/course-management/coursepublic-share-percent/${depId}`
        );
    }
}
