...
export class UserManagementService {
    ...
    putUserRole(roleId: number, autRoleData: AutRoleData): Observable<ResponseOneIf<AutRoleData>> {
        return this.http.put<ResponseOneIf<AutRoleData>>(`${environment.apiUrl}/user-management/user-role/${roleId}`, autRoleData);
    }
    ...
    postUserRole(autRoleData: AutRoleData): Observable<ResponseOneIf<AutRoleData>> {
        return this.http.post<ResponseOneIf<AutRoleData>>(`${environment.apiUrl}/user-management/user-role`, autRoleData);
    }
    ...
    findUserRole(autUserData: AutUserData): Observable<ResponseListIf<AutUserData>> {
        return this.http.post<ResponseListIf<AutUserData>>(
            `${environment.apiUrl}/user-management/find-user-role`,
            autUserData
        );
    }
